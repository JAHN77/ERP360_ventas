...
const FacturasPage: React.FC = () => {
  ...
  const handleRefacturar = async () => {
    ...
    console.log('[Refacturar] Re-timbrando factura rechazada:', selectedFactura.id);
    
    // Simplemente volver a timbrar la factura existente (enviar el JSON nuevamente)
    await handleTimbrar(selectedFactura.id);
  };
