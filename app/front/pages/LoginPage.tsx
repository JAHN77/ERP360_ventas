...
const LoginPage: React.FC = () => {
  ...
  const [selectedCompany, setSelectedCompany] = useState<Company | null>(DEFAULT_COMPANY);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoggingIn(true);
    try {
      // Pass undefined or default ID. If backend is single-tenant, it effectively ignores it or uses it for context
