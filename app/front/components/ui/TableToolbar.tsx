...
export const TableToolbar: React.FC<TableToolbarProps> = ({
  ...
  return (
    <div className="flex flex-col gap-2 sm:gap-3 p-2 sm:p-3 md:p-3 bg-white dark:bg-slate-800 rounded-lg">
        ...
        <div className="flex flex-col sm:flex-row w-full sm:w-auto items-center gap-4">
          <div className="relative w-full sm:w-auto sm:max-w-xs">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-2 text-sm text-slate-800 dark:text-slate-200 bg-white dark:bg-slate-900/50 border border-slate-300 dark:border-slate-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder:text-slate-400 dark:placeholder:text-slate-500"
            />
          </div>
          {onCustomizeColumns && (
            <button
              ...
              className="flex items-center justify-center gap-2 px-4 py-2 text-sm font-semibold bg-white dark:bg-slate-900/50 border border-slate-300 dark:border-slate-700 rounded-lg text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700/80 transition-colors flex-shrink-0"
            >
        ...
        <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto flex-shrink-0 flex-wrap">
          {onExportAction && exportActionLabel && (
            <button
              ...
              className="px-3 sm:px-4 py-2 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700 transition-colors shadow-sm hover:shadow-md w-full sm:w-auto flex items-center justify-center text-xs sm:text-sm"
            >
