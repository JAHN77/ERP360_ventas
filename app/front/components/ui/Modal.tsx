...
const Modal: React.FC<ModalProps> = ({ isOpen, onClose, title, children, size = 'lg', noPadding = false }) => {
  useEffect(() => {
  ...
  return (
    ...
    >
      <div 
        className={`bg-white/95 dark:bg-slate-800/90 backdrop-blur rounded-none sm:rounded-lg shadow-2xl w-full max-w-[95vw] sm:max-w-full ${sizeClasses[size]} transform transition-all duration-300 flex flex-col h-[95vh] sm:h-auto sm:max-h-[85vh]`}
