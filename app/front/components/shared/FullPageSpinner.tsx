  ...
  return (
    <div className="fixed inset-0 bg-slate-50 dark:bg-slate-900 flex flex-col items-center justify-center z-[9999]">
      <div className="flex items-center justify-center h-20 mb-6">
        <img src="/assets/ciclolider.png" alt="Ciclo Lider" className="h-16 w-auto object-contain" />
      </div>
      ...
      <div className="flex items-center space-x-2 mb-4">
        <div className="w-4 h-4 rounded-full bg-red-400 animate-pulse [animation-delay:-0.3s]"></div>
        <div className="w-4 h-4 rounded-full bg-red-400 animate-pulse [animation-delay:-0.15s]"></div>
