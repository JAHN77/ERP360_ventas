...
require('dotenv').config({ path: path.join(__dirname, 'app/back/.env') });
const { executeQueryWithParams } = require('./app/back/services/sqlServerClient.cjs');
const { TABLE_NAMES } = require('./app/back/services/dbConfig.cjs');
